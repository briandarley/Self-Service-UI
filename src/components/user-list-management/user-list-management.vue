  ...
  <div class="user-list-management">
        ...
        <div class="container">
          <div class="add-member">
            ...
            >
              ...
              <div class="submit">
                <button class="btn btn-primary" @click="onLookupMember()">
                  Search
                </button>
    ...
    <confirm-dialog id="confirmAddEntity" ref="confirmAddEntity" width="800">
      ...
      <div slot="modal-footer">
        <button class="btn btn-primary" @click="onConfirmAddMemberClick()">
          add entity
        </button>
        <button class="btn btn-secondary" @click="onCancelConfirmClick()">
          cancel
        </button>
      </div>
    </confirm-dialog>
