  ...
  return {
    async getCurrentMassMailByUser() {
      try {
        ...
        let response = await handler.get(
          `/massmail/campaigns/my-saved-campaigns`
        );
    ...
    async getMassMailAudienceTotals() {
      try {
        ...
        let response = await handler.get(
          `/massmail/create-request/audience-criteria/totals`
        );
    ...
    async getCampaignActions(campaignId) {
      try {
        ...
        let response = await handler.get(
          `/MassMail/campaign-actions/${campaignId}`
        );
    ...
    async getMassMailUserProfile(onyen) {
      try {
        ...
        let response = await handler.get(
          `/MassMail/create-request/audience-criteria/users/${onyen}`
        );
    ...
    async save(model) {
      ...
      if (!model.id) {
        ...
        //TODO ensure include/exclude populations are a string array and not a complex object
    ...
    async updateStatus(model) {
      try {
        ...
        await handler.put(
          `/massmail/campaign-status/${model.campaignId}`,
          model
        );
    ...
    async cloneCampaign(campaignId) {
      try {
        ...
        let response = await handler.post(
          `/massmail/campaigns/${campaignId}/clone`
        );
    ...
    async sendTestCampaign(campaignId, recipients) {
      try {
        ...
        await handler.post(
          `/massmail/send-test-message/${campaignId}`,
          recipients
        );
    ...
    async verifyCampaignReceipt(campaignId, onyen) {
      try {
        ...
        let response = await handler.get(
          `/massmail/campaigns/${campaignId}/recipients/${onyen}/verify-receipt`
        );
    ...
    async getCampaignReadStatistics(campaignId) {
      try {
        ...
        let response = await handler.get(
          `/massmail/campaigns/${campaignId}/read-statistics`
        );
