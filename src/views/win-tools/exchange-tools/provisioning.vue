            ...
            <div class="alert alert-info">
              ...
              <div class="input-controls">
                ...
                <div class="form-group form-inline">
                  ...
                  <div class="buttons">
                    <button class="btn btn-primary pull-right" @click="removeSelectedEmail()">Remove</button>
                  </div>
                </div>
              </div>
            </div>
...
export default class Provisioning extends Vue {
  ...
  populateEmails() {
    this.emailResponse = [];
    if (this.userLdap.mail) {
      this.emailResponse.push(this.userLdap.mail);
    } else if (this.userLdap.uncEmail) {
      this.emailResponse.push(this.userLdap.uncEmail);
    }
