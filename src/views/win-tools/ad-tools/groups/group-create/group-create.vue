<template>
  ...
  >
      ...
      <div class="card-body">
        ...
        <div class="border border-primary">
          ...
          <div class="m-2">
            ...
            <div class="row-3" v-if="model.groupTypeCode === 'SHARED_MAILBOX'">
              <div class="form-group">
                <label for="reply-to"
            ...
            <div class="row-4">
              <div class="form-group">
                <label for="reply-to">Description (Optional)</label>
                <input
                  type="text"
                  class="form-control"
                  name="description"
    ...
    <confirm-dialog
      id="confirmGroupCreated"
      ref="confirmGroupCreated"
      width="800"
    >
      <div slot="modal-title" class="text-white">
        Grouped Successfully Queued
      </div>
      <div slot="modal-body">
        <div>
          <p>Group has been successfully queued for creation.</p>
          <p>
            An email will be sent to '{{ currentUser.profile.email }}' when the
