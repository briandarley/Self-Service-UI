    ...
    <div class="card card-icon">
      ...
      <div class="card-body">
        ...
        <div class="container" v-if="showAddMembers">
          ...
          @entityRemoved="onGroupEntityRemoved"
          @entitiesAdded="onGroupEntitiedAdded"
          ></user-list-management>
          ...
          <div class="section add-entity mt-3">
            ...
            @entityRemoved="onGroupManagerEntityRemoved"
            @entitiesAdded="onGroupManagerEntitiedAdded"
            >
            </manager-list-management>
