      ...
      <div class="card-body">
        <div class="container">
          <div class="alert alert-info">
            ...
            <div>
              <p>
                Use the search field to search for lists by name or use a known
                subscriber's email to search lists where the user is a member
                of.
              </p>
              <p>
                Lyris lists will be returned based on the search string entered.
                Use the edit link
                <i class="fa fa-pencil-square-o"></i> to edit the selected list.
              </p>
            </div>
          </div>
            ...
            <tabbed-item slot="tab_0">
              ...
              <div>
                <div class="form-group">
                  <label class="strong" for="list_name" id="lblListNameSearch"
                    >List Name</label
                  >
                  <input
                    type="text"
                ...
                <div class="search-result mt-5">
                  <transition name="fade">
                    <div
                      class="row m-5 no-result"
                      v-if="noListNameSearchResult"
                    >
                      <div class="col">
                  ...
                  <div v-if="listNameSearchData.length" role="table">
                    <div
                      class="row bg-primary text-white row-header"
                      role="rowheader"
                    >
                    ...
                    >
                      ...
                      <div role="cell" class="col-2 edit-col text-right">
                        ...
                        >
                          ...
                          <span class="hide-text"
                            >Delete List {{ item.listName }}</span
                          >
                        </a>
                      </div>
                    </div>
            ...
            <tabbed-item slot="tab_1">
              <div>
                ...
                <div class="d-flex">
                  ...
                  <label for="student-checkbox"
                    >Is List Admin? (Limit lists to lists managed by provided
                    email)</label
                  >
                </div>
                <div class="text-right mb-5">
                  <button class="btn btn-primary mr-1" @click="searchByEmail()">
                    Search
                  </button>
                  <button class="btn btn-secondary" @click="clear()">
                    Clear
                ...
                <div v-if="emailSearchData.length" class="my-3 mt-5">
                  <span class="h5 text-primary"
                    >Total Records:
                    {{ emailSearchData.length | formatNumber }}</span
                  >
...
export default class PostmasterTools extends BaseListServePostMasterSearchMixin {
  ...
  async mounted() {
    ...
    this.ScreenReaderAnnouncerService.sendPageLoadAnnouncement(
      "Lyris Post Master Tools Landing"
    );
  }
}
</script>
