<template>
  <div class="container">
    <div class="card card-icon" v-if="this.userSubscriptions.length > 0">
...
<script src="./listserv-subscriptions.js"></script>
<style lang="scss" src="./listserv-subscriptions.scss" scoped></style>
